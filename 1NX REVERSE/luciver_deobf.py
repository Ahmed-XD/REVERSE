...
# Obfuscations are Made for Deobfuscate
...
luciverxd = []
ngentott = []
sys.stdout.write('\x1b]2; LUCIVERPREMIUMV2 Python\x07')
...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Dalvik/2.1.0 (Android 13; SM-S918B Build/TP1A.220624.014.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/ SM-S918B;FBSV/13;FBCA"
	...
	ngentot3 = f"Dalvik/2.1.0 (Android 13; SM-S918B Build/TP1A.220624.014.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/ SM-S918B;FBSV/13;FBCA"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Dalvik/2.1.0 (Android 13; SM-S918B Build/TP1A.220624.014.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/ SM-S918B;FBSV/13;FBCA"
...
HH   HH   AAA    CCCCC  KK  KK        PPPPPP  RRRRRR  EEEEEEE MM    MM 
HH   HH  AAAAA  CC    C KK KK         PP   PP RR   RR EE      MMM  MMM 
HHHHHHH AA   AA CC      KKKK   _____  PPPPPP  RRRRRR  EEEEE   MM MM MM 
HH   HH AAAAAAA CC    C KK KK         PP      RR  RR  EE      MM    MM 
HH   HH AA   AA  CCCCC  KK  KK        PP      RR   RR EEEEEEE MM    MM                                                                        
                              🇵​​🇷​​🇪​​🇲​​🇮​​🇺​​🇲​
                  {H2} 𝕄𝕒𝕕𝕖 𝔹𝕪 {M2}𝔸𝕣𝕚 𝕄𝕒𝕣𝕤𝕙𝕖𝕝𝕝𝕠 {P2}ℂ𝕠𝕕𝕖𝕣""",width=95,padding=(0,10),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐒𝐢 𝐆𝐚𝐧𝐭𝐞𝐧𝐠 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
...
class Login:
	...
	def menu_login(self):
		Logo().logonya()
		prints(Panel(f" {M2}𝐀𝐮𝐭{P2}𝐡𝐨𝐫   {P2}: {H2}𝑳𝒖𝒄𝒊𝒗𝒆𝒓𝑿𝑫\n {M2}𝐆𝐢𝐭{P2}𝐡𝐮𝐛  {P2} : {H2}𝒈𝒊𝒕𝒉𝒖𝒃.𝒄𝒐𝒎/𝑳𝒖𝒄𝒊𝒗𝒆𝒓𝑿𝑫\n{M2} 𝐅𝐚𝐜{P2}𝐞𝐛𝐨𝐨𝐤 {P2}: {H2}𝑳𝒖𝒄𝒊𝒗𝒆𝒓𝑿𝑫\n{M2} 𝐖𝐡𝐚{P2}𝐭𝐬𝐚𝐩𝐩 {P2}: {H2}+𝟔𝟐*************",width=43,padding=(0,2),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐈𝐧𝐟𝐨-𝐀𝐮𝐭𝐡𝐨𝐫 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		prints(Panel(f"{H2}\t                            {P2}𝐌𝐞𝐧𝐮 𝐋𝐨𝐠𝐢𝐧",width=87,style=f"{W1}"))
		prints(Panel(f"""{P2}[{color_text}𝟎𝟏{P2}]. 𝐥𝐨𝐠𝐢𝐧 𝐦𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐤𝐚𝐧 {H2}𝐜𝐨𝐨𝐤𝐢𝐞 ( {H2}ℝ𝕖𝕔𝕠𝕞𝕖𝕟𝕕𝕖𝕕{P2} )\n[{color_text}𝟎𝟐{P2}]. 𝐥𝐨𝐠𝐢𝐧 𝐦𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐤??𝐧 𝐍𝐨 𝐝𝐚𝐧 𝐏𝐚𝐬𝐬𝐰𝐨𝐫𝐝 ( {M2}ℕ𝕠 ℝ𝕖𝕔𝕠𝕞𝕖𝕟𝕕𝕖𝕕{P2} )""",width=87,style=f"{W1}"))
...
class Menu:
	...
	def menu(self):
		...
		self.jol = Console()
		self.tol = Console()
		prints(Panel(f"{K2}        {self.negara}",width=87,padding=(0,30),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐓𝐢𝐧𝐠𝐠𝐚𝐥 𝐃𝐢 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		yonkou.append(Panel(f" {M2}𝐍𝐚𝐦𝐚 {P2}𝐀𝐤𝐮𝐧       {P2}: {H2}{nama}\n {M2}𝐒𝐭𝐚𝐭𝐮𝐬 {P2}𝐔𝐬𝐞𝐫     {P2}: {H2}𝐏𝐫𝐢𝐯𝐚𝐭\n {M2}𝐈𝐩 {P2}𝐀𝐝𝐝𝐫𝐞𝐬𝐬      {P2}: {H2}{self.ip}\n {M2}𝐓𝐚𝐧{P2}𝐠𝐠𝐚𝐥         {P2}: {H2}{tgl}",width=43,padding=(0,2),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐈𝐧𝐟𝐨-𝐔𝐬𝐞𝐫 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		yonkou.append(Panel(f" {M2}𝐀𝐮𝐭{P2}𝐡𝐨𝐫   {P2}: {H2}𝐋𝐮𝐜𝐢𝐯𝐞𝐫𝐗𝐩𝐥𝐨𝐢𝐭\n {M2}𝐆𝐢𝐭{P2}𝐡𝐮𝐛  {P2} : {H2}𝒈𝒊𝒕𝒉𝒖𝒃.𝒄𝒐𝒎/𝐋𝐮𝐜𝐢𝐯𝐞𝐫𝐗𝐩𝐥𝐨𝐢𝐭\n{M2} 𝐅𝐚𝐜{P2}𝐞𝐛𝐨𝐨𝐤 {P2}: {H2}𝐋𝐮𝐜𝐢𝐯𝐞𝐫𝐗𝐩𝐥𝐨𝐢𝐭\n{M2} 𝐖𝐡𝐚{P2}𝐭𝐬𝐚𝐩𝐩 {P2}: {H2}+𝟔𝟐*************",width=43,padding=(0,2),title=f"{M2}■ {H2}■ {B2}■ {P2}𝐈𝐧𝐟𝐨-𝐀𝐮𝐭𝐡𝐨𝐫 {B2}■ {H2}■ {M2}■",style=f"{W1}"))
		self.jol.print(Columns(yonkou))
		prints(Panel(f"{P2}\t                           𝐃𝐚𝐟𝐭𝐚𝐫 𝐌𝐞𝐧𝐮",width=87,style=f"{W1}"))
		...
		if menu in["logout"]:
			...
			exit(prints(Panel(f"""{H2}𝐛𝐞𝐫𝐡𝐚𝐬𝐢𝐥 𝐦𝐞𝐧𝐠𝐡𝐚𝐩𝐮𝐬 𝐜𝐨𝐨𝐤𝐢𝐞, 𝐬𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐤𝐞𝐭𝐢𝐤 𝐮𝐥𝐚𝐧𝐠 𝐩𝐲𝐭𝐡𝐨𝐧 𝐩𝐫𝐞𝐦𝐢𝐮𝐦𝐯𝟐.𝐩𝐲""",width=87,style=f"{W1}")))
...
class Crack:
	...
	def simpan_hasil(self):
		...
		prints(Panel(f"""\r     {P2}User Agent Atau UA Sudah Di Perbarui Oleh LuciverXploit {K2}!!!""",width=87,padding=(0,10),style=f"{W1}"))
