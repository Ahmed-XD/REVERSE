...
def Main(id,name):
	...
	print(f'{H}━━'* 26)
	print(f'{P}[{H}>{P}] 1.𝐏𝐮𝐛𝐥𝐢𝐤 {P}[{H}>{P}] 2.𝐌𝐚𝐬𝐬𝐚𝐥  {P}[{H}>{P}] 3.𝐔𝐧𝐚𝐦𝐞 {P}[{H}>{P}] 4.𝐂𝐥𝐨𝐧𝐞')
	print(f'{P}[{H}>{P}] 5.𝐅𝐢𝐥𝐞   {P}[{H}>{P}] 6.𝐑𝐞𝐬𝐬𝐮𝐥𝐭 {P}[{H}>{P}] 7.𝐆𝐦𝐚𝐢𝐥 {P}[{H}>{P}] 8.𝐄𝐱𝐢𝐭𝐞𝐝  ')
	print(f'{H}━━'* 26)
...
### SETTING METHOD ###
	print(f'{H}━━'* 26)
	print(f'{P}[{H}>{P}] 1.𝑽𝑨𝑳𝑰𝑫𝑨𝑻𝑬 {P}[{H}>{P}] 2.𝑽𝑨𝑳𝑰𝑫𝑨𝑻𝑬 {P}[{H}>{P}] 3.𝑮𝑹𝑨𝑷𝑯 𝑨𝑷𝑰')
